...
jobs = [(j("vim"), "~/.vim"), (j("htoprc"), "~/.htoprc"), (j("theanorc"), "~/.theanorc"), (j("vimrc"), "~/.vimrc"), (j("gitconfig"), "~/.gitconfig"), (j("gitignore"), "~/.gitignore"), (j("tmux.conf"), "~/.tmux.conf"), (j("htoprc"), "~/.config/htop/htoprc") ]
